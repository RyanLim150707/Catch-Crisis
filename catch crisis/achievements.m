...
SKSpriteNode *player,*pause_gam,*left,*lifebox;
...
-(id)initWithSize:(CGSize)size {
    ...
    if (self = [super initWithSize:size]) {
        ...
        if(self.frame.size.height==1334){//iphone6
            ...
            livescore.position=CGPointMake(CGRectGetMaxX(self.frame)-scorebox.size.width+20, CGRectGetMaxY(self.frame)-scorebox.frame.size.width/1.3+10);
        }
            ...
            heart1.position=CGPointMake(CGRectGetMinX(self.frame)+scorebox.size.width+heart1.size.width-35, CGRectGetMaxY(self.frame)-scorebox.frame.size.width/1.7);
            heart2.position=CGPointMake(CGRectGetMinX(self.frame)+scorebox.size.width+heart1.size.width*2-30, CGRectGetMaxY(self.frame)-scorebox.frame.size.width/1.7);
            ...
            heart1.position=CGPointMake(CGRectGetMinX(self.frame)+scorebox.size.width+heart1.size.width-5, CGRectGetMaxY(self.frame)-scorebox.frame.size.width+3);
            heart2.position=CGPointMake(CGRectGetMinX(self.frame)+scorebox.size.width+heart2.size.width*2, CGRectGetMaxY(self.frame)-scorebox.frame.size.width+3);
            ...
            hearts.position=CGPointMake(CGRectGetMinX(self.frame)+scorebox.size.width-10, CGRectGetMaxY(self.frame)-scorebox.frame.size.width+5);
            heart1.position=CGPointMake(CGRectGetMinX(self.frame)+scorebox.size.width+heart1.size.width-5, CGRectGetMaxY(self.frame)-scorebox.frame.size.width+3);
            heart2.position=CGPointMake(CGRectGetMinX(self.frame)+scorebox.size.width+heart1.size.width*2+2, CGRectGetMaxY(self.frame)-scorebox.frame.size.width+3);
            livescore.position=CGPointMake(CGRectGetMaxX(self.frame)-scorebox.size.width, CGRectGetMaxY(self.frame)-scorebox.frame.size.width);
        }
        else{//iphone6
...
-(void)reportscore{
    ...
    GKScore *sco = [[GKScore alloc] initWithLeaderboardIdentifier:@"catchCrisis"];
    sco.value =score;
...
-(void)endscreen{
    ...
    endscreen=[LHNode spriteNodeWithImageNamed:@"imageresource/score/score_bannerWarrior"];
    endscreen.position=CGPointMake(CGRectGetMidX(self.frame), CGRectGetMaxY(self.frame)-self.frame.size.height/3);
    endscreen.zPosition=1;
    
    score_onend=[[SKLabelNode alloc]init];
    score_onend.name=@"scoreonend";
    score_onend.zPosition=4;
    ...
    NSString *num = [NSString stringWithFormat:@"%li",score];
    [score_onend setText:num];
    [score_onend setFontSize:80.0];
    [score_onend setFontColor:[UIColor brownColor]];
    
    
    e_home=[LHNode spriteNodeWithImageNamed:@"imageresource/score/score_home"];
    e_home.zPosition=1;
    e_home.position=CGPointMake(CGRectGetMinX(self.frame)-self.frame.size.width/3+e_home.frame.size.width+30, CGRectGetMinY(self.frame)-e_home.frame.size.height*3-20);
    e_home.name=@"ehome";
    e_retry=[LHNode spriteNodeWithImageNamed:@"imageresource/score/score_retry"];
    e_retry.zPosition=1;
    e_retry.position=CGPointMake(CGRectGetMinX(self.frame)-self.frame.size.width/3+e_home.frame.size.width*2.4, CGRectGetMinY(self.frame)-e_retry.frame.size.height*3-12);
    e_retry.name=@"eretry";
    
    
    e_leaderboard=[LHNode spriteNodeWithImageNamed:@"imageresource/score/score_leaderBoard"];
    e_leaderboard.zPosition=1;
    e_leaderboard.position=CGPointMake(CGRectGetMinX(self.frame)-self.frame.size.width/3+e_leaderboard.frame.size.width*3.6, CGRectGetMinY(self.frame)-e_leaderboard.frame.size.height*3-30);
    e_leaderboard.name=@"eleaderboard";
    
    e_facebook=[LHNode spriteNodeWithImageNamed:@"imageresource/score/score_facebook"];
    e_facebook.name=@"efacebook";
    e_facebook.zPosition=5;
    e_facebook.position=CGPointMake(CGRectGetMinX(self.frame)+e_facebook.frame.size.width, CGRectGetMinY(self.frame)+e_facebook.frame.size.width);
    e_twitter=[LHNode spriteNodeWithImageNamed:@"imageresource/score/score_twitter"];
    e_twitter.name=@"etwitter";
    e_twitter.zPosition=5;
    e_twitter.position=CGPointMake(CGRectGetMinX(self.frame)+e_facebook.frame.size.width*2.7, CGRectGetMinY(self.frame)+e_facebook.frame.size.width);
    highest_score=[[SKLabelNode alloc]init];
    NSString *yo=@"highestscore   ";
    NSString *temp = [NSString stringWithFormat:@"%li",high_score];
    
    [highest_score setText:[yo stringByAppendingString:temp]];
    highest_score.zPosition=6;
    highest_score.position=CGPointMake(CGRectGetMinX(self.frame)+e_facebook.frame.size.width*1.8, CGRectGetMinY(self.frame)+e_facebook.frame.size.width*2);
    [highest_score setFontName:@"PoetsenOne-Regular"];
    
    [highest_score setFontSize:35.0];
    [highest_score setFontColor:[UIColor blueColor ]];
    [highest_score setAlpha:0.5];
    
    highest_combo=[[SKLabelNode alloc]init];
    highest_combo.name=@"highestcombo";
    highest_combo.zPosition=6;
    highest_combo.position=CGPointMake(CGRectGetMinX(self.frame)+e_facebook.frame.size.width*1.8, CGRectGetMinY(self.frame)+e_facebook.frame.size.width*1.5);
    [highest_combo setFontName:@"PoetsenOne-Regular"];
    NSString *my=@"Highest Combo      ";
    [highest_combo setFontSize:35.0];
    [highest_combo setFontColor:[UIColor blueColor ]];
    [highest_combo setAlpha:0.5];
    NSString *man = [NSString stringWithFormat:@"%d",421];
    [highest_combo setText:[my stringByAppendingString:man]];
    [endscreen addChild:e_retry];
    [endscreen addChild:e_home];
    [endscreen addChild:e_leaderboard];
    [self addChild:highest_score];
    [self addChild:e_twitter];
    [self addChild:e_facebook];
    [self addChild:score_onend];
    [self addChild:endscreen];
    [self addChild:highest_combo];
    [self achievement];
...
-(void)changepattern:(int)blackhit change:(int)change{
    ...
    if(timecount<60){
        ...
        if(timecount<30){
            ...
            [self changetime:0.8 gravity:-2.5f];
            [self coinrotationspeed:0.055];
             ...
             NSLog(@"-3.5 speed");
            [self changetime:0.7 gravity:-3.5f];
            [self coinrotationspeed:0.044];
        }
        
    }
    else if((timecount >60) && (blackhit==1)){
        patterncategory=2;
        
        [self changetime:0.5 gravity:-5.5f];
        [self coinrotationspeed:0.033];
        NSLog(@"1speed4");
        ...
        patterncategory=3;
        [self changetime:0.35 gravity:-7.0f];
        [self coinrotationspeed:0.031];
...
-(void)changetime:(float)timecc gravity:(float)g {
    if(lottery_catched==1 && score > high_score){
        g=-7.5f;
        timecc=0.25;
    
    }
    else if(lottery_catched==1 && timecount>60){
        g=-5.5f;
        timecc=0.4;
    }
    else if(lottery_catched==1 && timecount<60){
    ...
    [self coinAction:timecc];
    self.physicsWorld.gravity = CGVectorMake(0.0f,g);
...
-(void)makepause{
    ...
    p_home.zPosition=1;
    p_home.position=CGPointMake(CGRectGetMinX(self.frame)-self.frame.size.width/3-30, CGRectGetMinY(self.frame)-p_home.size.height*2+10);
    p_home.zPosition=5;
    p_home.name=@"phome";
    
    p_replay=[LHNode spriteNodeWithImageNamed:@"imageresource/pause/pause_retry"];
    p_replay.position=p_resume.position=CGPointMake(CGRectGetMinX(self.frame)-self.frame.size.width/10+30, CGRectGetMinY(self.frame)-p_replay.size.height-p_replay.size.height/2-6);
    p_replay.zPosition=5;
    p_replay.name=@"preplay";
    p_resume=[LHNode spriteNodeWithImageNamed:@"imageresource/pause/pause_play"];
    p_resume.position=CGPointMake(CGRectGetMinX(self.frame)-self.frame.size.width/3+p_resume.size.height-20, CGRectGetMinY(self.frame)-p_home.size.height-p_resume.size.height/2-15);
...
-(void)coins{
    ...
    if(a==2){
        ...
        ring.physicsBody.friction=0.4f;
    ...
    //ring3
        ...
        ring1.physicsBody.friction=0.04f;
    ...
    //ring1
        ...
        ring2.physicsBody.friction=0.4f;
        ring2.zPosition=1;
        if(banana!=1){
...
-(void)callendscreen{
   ...
   long t=(long)[temp longLongValue];
    ...
    [self achievement];
    [self reportscore];
    [shared sharedInstance].score=score;
...
-(void)didBeginContact:(SKPhysicsContact *)contact{SKPhysicsBody *firstBody;
    ...
    if([my.name isEqualToString:@"lottery"] && [bottom.name isEqualToString:@"player"]){
        ...
        [self badcoin_anim];
        [self changetime:0.7 gravity:-5.5f];
        lottery_catched=1;
        lottery_check=1;
    }
...
-(void)adds{
    ...
    [Chartboost startWithAppId:@"555f30e643150f490bc16d0d"
        ...
        if([Chartboost hasInterstitial:CBLocationPause] == YES) {
